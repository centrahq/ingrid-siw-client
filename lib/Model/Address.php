...
class Address implements ModelInterface, ArrayAccess
{
     ...
     * Sets coordinates
     *
     * @param \Swagger\Client\Model\Coordinates $coordinates Geolocation coordinates of the address. If reverse geolocation lookup of the address was successful this property will be populated. If coordinates are available they will be used to in service point search. In case of `search_address` coordinates can also be set by merchant if known.
     *
     * @return $this
     */
