...
class CompleteSessionRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id WarehouseID specifies from which warehouse order will be sent. If it is not supplied and site has only one warehouse, this warehouse will be used as sender. Otherwise order will have no sender.
     *
     * @return $this
     */
