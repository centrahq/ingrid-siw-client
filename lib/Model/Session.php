...
class Session implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Swagger\Client\Model\AdditionalInfo $additional_information Additional information associated with the session.
     *
     * @return $this
     */
     ...
     * Sets expires_at
     *
     * @param string $expires_at Time at which shipping options start to invalidate, in RFC 3339 format.
     *
     * @return $this
     */
     ...
     * Sets tos_id
     *
     * @param string $tos_id TosId identifies the order which the session belongs to. The tos id is available if the session was created from an order or when the session is completed.
     *
     * @return $this
     */
