...
class DefaultApi
{
     ...
     *
     * @param  \Swagger\Client\Model\CreateSessionFromOrderRequest $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\CreateSessionFromOrderResponse
     */
    public function siwCreateSessionFromOrder($body)
    {
        list($response) = $this->siwCreateSessionFromOrderWithHttpInfo($body);
        return $response;
    }
     ...
     * Creates a session from an already existing order.
     *
     * @param  \Swagger\Client\Model\CreateSessionFromOrderRequest $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CreateSessionFromOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function siwCreateSessionFromOrderWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\CreateSessionFromOrderResponse';
        $request = $this->siwCreateSessionFromOrderRequest($body);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CreateSessionFromOrderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function siwCreateSessionFromOrderAsync($body)
    {
        return $this->siwCreateSessionFromOrderAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function siwCreateSessionFromOrderAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\CreateSessionFromOrderResponse';
        $request = $this->siwCreateSessionFromOrderRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function siwCreateSessionFromOrderRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function siwListSessionsSummariesRequest($tos_id = null)
    {
        ...
        // query params
        if ($tos_id !== null) {
            $queryParams['tos_id'] = ObjectSerializer::toQueryValue($tos_id);
        }
